...
export const Billing = ({ user, billing }: Props) => (
  <Html>
    <Head />
      ...
      <Container style={container}>
        ...
        <Section style={message}>
          ...
          <Text style={global.text}>
            {user.firstname} you order's is on its way. Use the link above to
            track its progress.
          </Text>
        ...
        <Section style={global.defaultPadding}>
          <Text style={adressTitle}>Shipping to: {billing.country}</Text>
        ...
        >
          {billing.books.map((book: any, i: number) => (
            <Row key={i}>
              <Column>
                <Img
                  src={book.cover}
          ...
          <Row style={{ display: "inline-flex", marginBottom: 40 }}>
            ...
            <Column>
              ...
              <Text style={track.number}>
                {moment(billing.createdAt).format("MMMM Do YYYY, h:mm:ss a")}
              </Text>
            </Column>
          </Row>
          <Row>
        ...
        <Section style={paddingY}>
          ...
          <Text style={footer.text}>
            © 2023 Online Library, Inc. All Rights Reserved.
          </Text>
          <Text style={footer.text}>
            Online Library, INC. One Bowerman Drive, Beaverton, Oregon 97005,
            USA.
          </Text>
        </Section>
      </Container>
